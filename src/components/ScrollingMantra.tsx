...
const ScrollingMantra = () => {
  ...
  return (
    <section className="py-12 md:py-16 bg-gradient-to-r from-saffron-light/30 via-gold-light/20 to-saffron-light/30">
      <div className="scrolling-text-container" ref={containerRef}>
        <div className="scrolling-text font-serif text-xl md:text-2xl lg:text-3xl text-divine-dark/80" ref={textRef}>
          Hare Krishna Hare Krishna Krishna Krishna Hare Hare, Hare Rama Hare Rama Rama Rama Hare Hare
        </div>
        <div className="scrolling-text font-serif text-xl md:text-2xl lg:text-3xl text-divine-dark/80" aria-hidden="true" style={{ animationDelay: '10s' }}>
          Hare Krishna Hare Krishna Krishna Krishna Hare Hare, Hare Rama Hare Rama Rama Rama Hare Hare
        </div>
      </div>
    </section>
